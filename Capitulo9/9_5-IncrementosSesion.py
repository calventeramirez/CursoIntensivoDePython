...
user = Usuario('Pepe', 'Gallardo', 'gallardoP', 'gallardop@gmail.com', "12345")

print(f'El numero de intentos de iniciar sesion es {user.intentos_inicios}')
user.incrementar_intentos_inicios()
user.incrementar_intentos_inicios()
print(f'El numero de intentos de iniciar sesion es {user.intentos_inicios}')
user.restablecer_intentos_incios()
print(f'El numero de intentos de iniciar sesion es {user.intentos_inicios}')